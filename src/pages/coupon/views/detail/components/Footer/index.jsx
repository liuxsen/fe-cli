 ...
 * @Last Modified time: 2019-11-26 16:16:56
 */
    ...
    return (
      <div className="detail-footer pst-fx b-0 l-0 r-0 h-100 bg-white">
        <ul className="flex fs-24 text-center">
          <li className="w-150 lh-100">
            <img className="mr-12" src="/static/images/show_home.png" />
            <span>首页</span>
          </li>
          <li className="w-150 lh-100">
            <img className="mr-12 mt-7" src="/static/images/show_home.png" />
            <span>乐享</span>
          </li>
